...
},{"lit-element":"../node_modules/lit-element/lit-element.js"}],"../node_modules/pwa-helpers/connect-mixin.js":[function(require,module,exports) {
"use strict";
...
},{}],"ui/stock-element.ts":[function(require,module,exports) {
"use strict";
...
},{"./app-element":"ui/app-element.ts"}],"../node_modules/symbol-observable/es/ponyfill.js":[function(require,module,exports) {
"use strict";
...
},{"symbol-observable":"../node_modules/symbol-observable/es/index.js"}],"store/store.ts":[function(require,module,exports) {
"use strict";
...
const store = redux_1.createStore(application, {});
store.dispatch({
  type: 'CHANGE_CONTEXT',
  context: {
    myContext: ''
...
},{"redux":"../node_modules/redux/es/redux.js"}],"ui/stocks-page.ts":[function(require,module,exports) {
"use strict";
...
const connect_mixin_js_1 = require("pwa-helpers/connect-mixin.js");

require("./stock-element");

const store_1 = __importDefault(require("../store/store"));

class StocksPage extends connect_mixin_js_1.connect(store_1.default)(app_element_1.AppElement) {
  render() {
    const stock = {
      'company': 'Apple',
      'name': 'APPL'
    };
    return app_element_1.html`<stock-element .stock=${stock} />`;
  }

}

customElements.define('stocks-page', StocksPage);
},{"./app-element":"ui/app-element.ts","pwa-helpers/connect-mixin.js":"../node_modules/pwa-helpers/connect-mixin.js","./stock-element":"ui/stock-element.ts","../store/store":"store/store.ts"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"application/router.ts":[function(require,module,exports) {
"use strict";
...
page_1.default('/', saveState, context => {
  console.log("barra", context);
});
page_1.default('/:stockId', saveState, context => {
  console.log("stockId", context);
});
page_1.default.start();
},{"page":"../node_modules/page/page.js","../store/store":"store/store.ts"}],"ui/news-page.ts":[function(require,module,exports) {
"use strict";
...
class NewsPage extends connect_mixin_js_1.connect(store_1.default)(app_element_1.AppElement) {
  constructor() {
  ...
  stateChanged(state) {
    this.news = {
      name: state.context.params.stockId
    };
  }

  render() {
    return app_element_1.html`${this.news.name}`;
  }

}

customElements.define('news-page', NewsPage);
},{"./app-element":"ui/app-element.ts","pwa-helpers/connect-mixin.js":"../node_modules/pwa-helpers/connect-mixin.js","./stock-element":"ui/stock-element.ts","../store/store":"store/store.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
require("./ui/news-page");
},{"./ui/stocks-page":"ui/stocks-page.ts","./application/router":"application/router.ts","./ui/news-page":"ui/news-page.ts"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35801" + '/');
